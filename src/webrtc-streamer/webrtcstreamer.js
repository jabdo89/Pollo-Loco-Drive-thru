var WebRtcStreamer = (function() {
  ...
  WebRtcStreamer.prototype.connect = function(
    ...
    if (!this.iceServers) {
      ...
      return fetch(this.srvurl + "/api/getIceServers")
        .then(this._handleHttpErrors)
        .then((response) => response.json())
        .then((response) => {
          return this.onReceiveGetIceServers.call(
            this,
            response,
            videourl,
            audiourl,
      ...
      return this.onReceiveGetIceServers(
        this.iceServers,
        videourl,
        audiourl,
        options,
  ...
  WebRtcStreamer.prototype.onReceiveGetIceServers = function(
    ...
    try {
      ...
      // create Offer
      var bind = this;
      return this.pc.createOffer(this.mediaConstraints).then(
        function(sessionDescription) {
          return bind.pc.setLocalDescription(
            sessionDescription,
            function() {
              fetch(callurl, {
                method: "POST",
                ...
                .then((response) => {
                  return bind.onReceiveCall.call(bind, response);
                })
                .catch((error) => bind.onError("call " + error));
            },
            function(error) {
  ...
  WebRtcStreamer.prototype.onAddStream = function(event) {
    ...
    document.getElementById("prueba").srcObject = event.stream;
    document.getElementById("prueba").top = "1000px";
  };
